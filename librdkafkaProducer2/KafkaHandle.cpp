...
InitKafkaProducerStatType KafkaHandle::Init(const std::string & kafkaConfigFilePath)
{
    m_ConfFilePath = kafkaConfigFilePath;

    InitKafkaProducerStatType kafkaHandleStatType;
...
InitKafkaProducerStatType KafkaHandle::_SetConfProperties()
{
...
InitKafkaProducerStatType KafkaHandle::_CreateKafkaHandle()
{
